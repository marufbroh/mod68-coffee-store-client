    ...
    return (
        <section className='container mx-auto bg-[#F4F3F0] p-24'>
            <div className='text-center'>
                <h3 className='text-3xl font-bold mb-3'>Add New Coffee</h3>
            ...
            <form onSubmit={handleAddCoffee}>
                ...
                <div className="form-control">
                    ...
                    <label className="input-group">
                        <input type="url" name='photourl' placeholder="Enter photo URL" className="input input-bordered w-full" />
                    </label>
                </div>
                <div className='flex w-full mt-4'>
                    <button className='bg-[#D2B48C] hover:bg-[#e08a19] p-3 rounded w-full font-bold border border-yellow-950' type='submit'>Add Coffee</button>
                </div>
            </form>
        </section>
    );
